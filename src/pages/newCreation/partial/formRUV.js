...
const FormRUV = ({name, dropdown, role}) => {
        ...
        <div className='bg-white rounded-lg'>
            <form onSubmit={handleSubmit(onSubmit)} className='mb-8 p-10'>
                ...
                <div className='grid 2xl:grid-cols-14 lg:grid-cols-10 md:grid-cols-2 gap-3 2xl:pl-2 lg:pl-0 mb-8'>
                    <section
                        className='flex flex-col text-left text-grey text-sm mt-2 lg:col-span-2 2xl:-mr-2  2xl:-ml-2 lg:-ml-0'>
                    ...
                    <section
                        className='flex flex-col text-left text-grey text-sm mt-2 lg:col-span-3 2xl:ml-3 lg:-ml-0'>
                        <label>Berater *</label>
                ...
                <div className='grid 2xl:grid-cols-14 lg:grid-cols-10 md:grid-cols-2 gap-3 2xl:pl-2 lg:pl-0'>
                    <section
                        className='flex flex-col text-left text-grey text-sm mt-2 lg:col-span-2 2xl:-ml-2 2xl:-mr-2 lg:-ml-0'>
                        <label>Bank *</label>
                    ...
                    <section
                        className='flex flex-col text-left text-grey text-sm mt-2 2xl:w-44 2xl:-ml-40 lg:mr-0 lg:-ml-0'>
