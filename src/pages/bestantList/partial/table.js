...
const BestantListTable = ({FirmaKurz,ZustBerater,Bank,RegioBereich,FBKBank,MA,PStatus,Note, printing}) => {
    ...
    return (
        <tr className="border-y border-silver border-x-0 text-sm">
            ...
            <td className="w-2/12 text-gray-900 font-light px-6 py-1 whitespace-pre-wrap">
                {ZustBerater}
            </td>
            <td className="w-2/12 text-gray-900 font-light px-6 py-1 whitespace-pre-wrap">
                {Bank}
            ...
            <td className="w-3/12 text-gray-900 font-light px-6 py-1 whitespace-pre-wrap">
                {FBKBank}
            </td>
            <td className="w-1/12 text-gray-900 font-light px-6 py-1 whitespace-pre-wrap">
                {MA}
            </td>
            <td className="w-2/12 text-gray-900 font-light px-6 py-1 whitespace-pre-wrap">
                {PStatus}
            </td>
            <td className="w-1/12 px-6 py-1 whitespace-nowrap font-light text-gray-900">
                21.10.22
            </td>
            <td hidden={printing} className="w-1/12 tooltip text-gray-900 font-light px-6 py-1 whitespace-pre-wrap">
